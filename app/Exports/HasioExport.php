...
class HasioExport implements FromView, WithEvents, WithTitle
{
    /**
    ...
    public function view(): View
    {
        if ($this->type == "sample") {
            if ($this->exportType == "market_monitoring") {
                return view('pages.sample_excel.hasio_market_monitoring', [
                    'columns' => Schema::getColumnListing('hasio_market_monitorings')
                ]);
            } else if ($this->exportType == "firm_registration") {
                return view('pages.sample_excel.hasio_firm_registration', [
                    'columns' => Schema::getColumnListing('hasio_firm_registrations')
                ]);
            } else if ($this->exportType == "training") {
                return view('pages.sample_excel.hasio_training', [
                    'columns' => Schema::getColumnListing('hasio_training'),
