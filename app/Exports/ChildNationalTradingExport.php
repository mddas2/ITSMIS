...
class ChildNationalTradingExport implements FromView, WithEvents, WithTitle
{
    ...
    {
        return SaltTradingLimitedPurchase::all();
    }
    ...
    public function view(): View
    {
        if ($this->exportType == "sample") {
            if ($this->customType == "purchase") {
                return view('pages.sample_excel.salt_trading_purchase', [
                ...
                return view('pages.sample_excel.salt_trading_sales', [
                    'customType' => $this->customType,
                    'items' => Item::pluck('name')->skip(0)->take(10)->toArray(),
                    'units' => MeasurementUnit::pluck('name', 'id')->toArray()
                ]);
