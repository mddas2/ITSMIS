...
<div class="card card-custom">
 	<div class="card-header">
        ...
        <div class="card-toolbar">
        	<a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('dcsc_market_monitoring_excel')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
		</div>
    </div>
	<div class="card-body">
		<form>
		...
		<form class="form" id="kt_form" action="{{route('dcsc_market_monitoring')}}" method="post">
	 		{{csrf_field()}}
	            ...
	            <tbody id="tb_id">
	                ...
	                <tr id="firstRow">
	                    ...
	                    <td>
	                    	...
	                    	<input type="text" name="data[{{$key}}][date]" class="form-control nepdatepicker" autocomplete="off" id="nepstart1" value="{{$today}}">
	                   </td>
	                   <td>
