...
<div class="card card-custom">
	<div class="card-body">
		<ul class="dashboard-tabs nav nav-pills nav-primary row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
			...
			<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
				<a class="nav-link border py-2 d-flex flex-grow-1 rounded flex-column align-items-center importPage" href="{{route('dcsc_firm_registration_report')}}">
					<span class="nav-icon py-3 w-auto">
						<span class="svg-icon svg-icon-3x">
...
<div class="card card-custom">
 	<div class="card-header">
        ...
        <div class="card-toolbar">
        	<a class="btn btn-info btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('market_monitoring_import_column')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import New Column')}}</a>
		</div>
    </div>
	<div class="card-body">
		<form>
