...
<div class="card card-custom">
	@include('pages.partials.dao_header_tiles')
</div>
<br>
<div class="card card-custom">
 	<div class="card-header">
        ...
        <div class="card-toolbar">
        	<a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('dao_market_monitoring_excel')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
		</div>
    </div>
	<div class="card-body">
		<form>
