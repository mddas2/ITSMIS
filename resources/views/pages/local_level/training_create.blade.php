    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header flex-wrap border-1 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('local_level_training_excel','training')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
            </div>
        </div>
        <div class="card-body">
            <form>
