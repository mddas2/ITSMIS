    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('iee_related_excel')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
            </div>
        </div>
        <div class="card-body">
            <form>
                ...
                <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                    ...
                    @foreach($data as $row)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="data[{{$key}}][no_of_iee_aproval]" class="form-control" autocomplete="off" value="{{$row->no_of_iee_aproval}}" {{$disabled}}>
                            </td>
                    ...
                    <tr id="firstRow">
                        ...
                        <td>
                            <input type="text" name="data[{{$key}}][no_of_iee_aproval]" class="form-control" autocomplete="off">
                        </td>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('.add').click(function(e){
            ...
            $("[name='data["+key+"][no_of_iee_aproval]']",rowClone).val("");
            ...
            $("[name='data["+key+"][no_of_iee_aproval]']",rowClone).attr('name','data['+tableCnt+'][no_of_iee_aproval]');
