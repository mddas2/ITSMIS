    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('repatriationApproval_excel')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
            </div>
        </div>
        <div class="card-body">
            <form>
                ...
                <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                    ...
                    @foreach($data as $row)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="data[{{$key}}][nationality_of_foreigner_investor]" class="form-control" autocomplete="off" value="{{$row->nationality_of_foreigner_investor}}" {{$disabled}}>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" name="data[{{$key}}][dividend]" class="form-control" autocomplete="off" value="{{$row->dividend}}" {{$disabled}}>
                            </td>

                            <td>
                                <input type="text" name="data[{{$key}}][royalty]" class="form-control" autocomplete="off" value="{{$row->royalty}}" {{$disabled}}>
                            </td>
                            <td>
                                <input type="text" name="data[{{$key}}][other]" class="form-control" autocomplete="off" value="{{$row->other}}" {{$disabled}}>
                            </td>
                    ...
                    <tr id="firstRow">
                        ...
                        <td>
                            <input type="text" name="data[{{$key}}][dividend]" class="form-control" autocomplete="off" >
                        </td>

                        <td>
                            <input type="text" name="data[{{$key}}][royalty]" class="form-control" autocomplete="off" >
                        </td>
                        <td>
                            <input type="text" name="data[{{$key}}][other]" class="form-control" autocomplete="off" >
                        </td>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $('.repatriationApproval').addClass("active");
        ...
        $('.add').click(function(e){
            ...
            $("[name='data["+key+"][nationality_of_foreigner_investor]']",rowClone).val("");
            $("[name='data["+key+"][amount]']",rowClone).val("");
            $("[name='data["+key+"][currency]']",rowClone).val("");
            $("[name='data["+key+"][dividend]']",rowClone).val("");
            $("[name='data["+key+"][royalty]']",rowClone).val("");
            $("[name='data["+key+"][other]']",rowClone).val("");
            ...
            $("[name='data["+key+"][nationality_of_foreigner_investor]']",rowClone).attr('name','data['+tableCnt+'][nationality_of_foreigner_investor]');
            ...
            $("[name='data["+key+"][dividend]']",rowClone).attr('name','data['+tableCnt+'][dividend]');
            $("[name='data["+key+"][royalty]']",rowClone).attr('name','data['+tableCnt+'][royalty]');
            $("[name='data["+key+"][other]']",rowClone).attr('name','data['+tableCnt+'][other]');
