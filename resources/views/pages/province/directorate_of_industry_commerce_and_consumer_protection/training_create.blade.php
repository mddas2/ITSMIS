    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header flex-wrap border-1 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Entrepreneurship Promotion Program - Province Level - Directorate of Industry, Commerce and Consumer Protection
                </h3>
            </div>
        ...
        <div class="card-body">
            ...
            <form class="form" id="kt_form" action="{{route('icacp_addTraining')}}" method="post">
                {{csrf_field()}}
