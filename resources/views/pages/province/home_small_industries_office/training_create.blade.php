...
@section('content')
    ...
    <div class="card card-custom gutter-b">
        @include('pages.partials.hasio_header_tiles')
        ...
        <div class="card-header flex-wrap border-1 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Entrepreneurship Promotion Program - Home And Small Industries Office
                </h3>
            </div>
            <div class="card-toolbar">
                <a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('hasio_training_excel','training')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
            </div>
        </div>
        <div class="card-body">
            <form>
            ...
            <form class="form" id="kt_form" action="{{route('hasio_addTraining')}}" method="post">
                {{csrf_field()}}
                <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable">
                    ...
                    @foreach($data as $row)
                        ...
                        <tr>
                            ...
                            <td>
                                {{Form::select('',$trainingList,$row->training_type_id,['class' => 'form-control  ','disabled'=> 'disabled'])}}
                            </td>
                            <td>
                                <input type="text" name="" class="form-control"  value="{{$row->male}}" disabled="">
                            </td>
                            <td>
                                <input type="text" name="" class="form-control"  value="{{$row->female}}" disabled="">
                            </td>
                            <td>
                                <input type="text" name="" class="form-control"  value="{{$row->age}}" disabled="">
                            </td>
                            <td>
                                <input type="text" name="" class="form-control"  value="{{$row->budget_spend_per_unit}}" disabled="">
                            </td>
                            <td>
