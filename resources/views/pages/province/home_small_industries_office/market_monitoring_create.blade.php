...
<div class="card card-custom">
 	<div class="card-header">
        ...
        <div class="card-toolbar">
        	<a class="btn btn-success btn-sm" href="javascript:;" data-fancybox data-type="ajax" data-src="{{route('hasio_market_monitoring_excel')}}" ><i class="fa fa-plus icon-sm"></i>{{ __('Import Excel')}}</a>
		</div>
    </div>
	<div class="card-body">
		<form>
		...
		<form class="form" id="kt_form" action="{{route('hasio_market_monitoring')}}" method="post">
	 		{{csrf_field()}}
