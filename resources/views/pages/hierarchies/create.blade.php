<div class="card card-custom">
    ...
    <div class="card-body">
        <div id="manage_hierarchy">
            <form class="form" id="kt_form" action="{{route('hierarchies.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label>Parent:<span style="color: #e9594d;">*</span></label>
                            {{Form::select('parent_id', $list, null,['class' => 'form-control form-control-solid','required'=>false])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input name="name_ne" type="text" class="form-control form-control-solid" placeholder="Enter Name Nepali" required autocomplete="off" />
                        </div>
                    </div>
