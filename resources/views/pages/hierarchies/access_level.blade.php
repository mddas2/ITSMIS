		...
		<div class="card-body">
			<div class="form-group row">
				<div class="col-lg-6">
					...
					{{Form::select('hierarchy_id',$list,null,['class'=>'form-control form-control-solid hierarchyList','required'=>true,'size' => 8])}}
				</div>
				<div class="col-lg-6">
					<label>Office:</label>
			...
			<div class="form-group row">
				<div class="col-lg-12">
					<label>Modules:</label>
					{{Form::select('module_id[]',$modules,null,['class'=>'form-control form-control-solid modules','required'=>true,'size' => 8,'multiple'=>true,'required'=>true])}}
				</div>
			</div>
		</div>
