...
<div class="card card-custom gutter-b">
	<div class="card-body">
 	...
 	<div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Monthly Training Report</h3>
        </div>
	...
	<div class="card-body">
		...
		<form class="form" id="kt_form" action="{{route('monthly_training_report',['fiscal_year_id'=> $fiscalYearId])}}" method="post">
	 		{{csrf_field()}}
...
<script type="text/javascript">
	$('.monthlyTraining').addClass("active");
