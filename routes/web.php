...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('get_module_have_category_list', 'ModulehascategoryController@getModuleHasCategoryList')->name('getModuleHasCategoryList');
    Route::post('store_module_have_category', 'ModulehascategoryController@StoreModuleHasCategory')->name('StoreModuleHasCategory');
...
//Department of Commerce, Supply and Consumer Right Protection - Permission to Import and Export
    ...
    Route::post('oil-level-consumption-add', 'ConsumptionController@OiladdAction')->name('OiladdAction');
    Route::get('oil-add-new-consumption', 'NepalOilCorporationController@addNewOilConsumption')->name('addNewOilConsumption');
    ...
    Route::post('salt-consumption-add', 'ConsumptionController@SaltConsumptionAddAction')->name('SaltConsumptionAddAction');
    Route::get('salt-new-add-consumption', 'ConsumptionController@AddSaltNewConsumption')->name('AddSaltNewConsumption');
    ...
    //Local Level Product Entry
        ...
        Route::post('local_level_add', 'LocalLevelController@addAction')->name('local_level_add');

        Route::get('local_level_add_production', 'LocalLevelController@addProduction')->name('local_level_add_production');
        Route::post('local_level_add_production', 'LocalLevelController@addActionImportProduction')->name('addActionImportProduction'); // this is when production is import from verify_production_registration.blade.php
    ...
    Route::get('admin/report/local-level-production/', 'FrontendController@local_level_production_report')->name('local_level_production_admin_report');
